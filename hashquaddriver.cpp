...
//./a.out dataSetA.csv hashquaddataseta.csv hashquadcollisionsA.csv
//./a.out dataSetB.csv hashquaddatasetb.csv hashquadcollisionsB.csv
int main(int argc, char* argv[]){
    ...
    HashTable *tab = new HashTable(10009);
        ...
        //gathering insert times and collisions
        float num1;
        int num5;
        int s = 0;
        int e = 100;
        ...
        //gathering search times and collisions
        float num2;
        int num3 = 0;
        int num4 = 100;
        int num6;
